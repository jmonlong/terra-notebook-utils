...
class LocalSSDDisk:
    """GCP persistent disk costs: https://cloud.google.com/compute/disks-image-pricing"""
    standard = 0.08 / MONTH  # GCP disk prices are quoted per month :(
...
class GCPCustomN2Cost:
    # Pricing information: https://cloud.google.com/compute/vm-instance-pricing#n2_predefinedg
    on_demand_per_cpu = 0.031611 / HOUR
    on_demand_per_gb = 0.004237 / HOUR
    preemptible_per_cpu = 0.00765 / HOUR
    preemptible_per_gb = 0.00103 / HOUR
